...
const experiences = [
  ...
  },
  {
    ...
    type: "Freelance",
    color: "#3B82F6",
    desc: "Built production-grade projects including Nexlify (agency landing page template), Velvra (luxury fashion e-commerce), and K72 (agency portfolio). Developed full stack skills across React, Next.js, Node.js, and MySQL.",
...
//           {/* Vertical line */}
//           <div className="absolute left-0 md:left-[200px] top-0 bottom-0 w-px bg-zinc-900">
//             <div
//               ref={lineRef}
...
//                 viewport={{ once: true }}
//                 custom={i}
//                 className="relative flex flex-col md:flex-row gap-6 md:gap-0 pb-16 last:pb-0"
//               >
//                 {/* Period — left side */}
...
//                 {/* Dot on line */}
//                 <div
//                   className="absolute left-[-5px] md:left-[195px] top-1 w-[11px] h-[11px] rounded-full border-2 border-[#0A0A0A] z-10"
...
//                     </div>
//                     <span
//                       className="text-[10px] font-mono tracking-[0.15em] uppercase px-3 py-1.5 rounded-full border flex-shrink-0"
//                       style={{
//                         color: exp.color,
...
//                   {/* Description */}
//                   <p className="text-zinc-400 text-sm leading-[1.8] mb-5">
//                     {exp.desc}
//                   </p>
...
//                       <span
//                         key={tag}
//                         className="text-[11px] font-mono tracking-wide px-3 py-1 rounded-full border border-white/8 text-zinc-600"
//                       >
//                         {tag}
//                       </span>
//                     ))}
